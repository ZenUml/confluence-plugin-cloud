      ...
      <div class="header flex" :class="{flex: isDisplayMode, hidden: !isDisplayMode}">
        <div class="left">
          <div class="actions flex" :class="{flex: isDisplayMode, hidden: !isDisplayMode}">
            ...
            <button v-show="!isLite" @click="downloadPng" class="flex p-1 ms-0.5 align-middle inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-800/[.15] dark:border-blue-800/[.2] dark:text-blue-500" title="Download PNG">
...
<!--            https://zenuml.com/confluence-migration-instructions/-->
            <a v-show="isLite" @click="trackUpgradeEvent"
               ...
               class="flex p-1 ms-0.5 align-middle inline bg-amber-50 border border-amber-300 text-amber-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-amber-800/[.15] dark:border-amber-800/[.2] dark:text-blue-500" title="Download PNG">
              <svg width="20" height="20" viewBox="0 0 24 24" role="presentation"><path d="M12 15a3 3 0 110-6 3 3 0 010 6zm1-12h6c1.136 0 2 1 2 2v6l-2-2V5h-4l-2-2zM3 11V5c0-1.136 1-2 2-2h6L9 5H5v4l-2 2zm8 10H5c-1.136 0-2-1-2-2v-6l2 2v4h4l2 2zm10-8v6c0 1.136-1 2-2 2h-6l2-2h4v-4l2-2z" fill="currentColor" fill-rule="evenodd"></path></svg>
              Upgrade
            </a>
            <send-feedback/>
