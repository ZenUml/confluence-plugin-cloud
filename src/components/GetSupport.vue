...
<div class="get-support">
  ...
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
       viewBox="0 0 100.353 100.353" width="20px" height="20px" style="enable-background:new 0 0 100.353 100.353;" xml:space="preserve">
    <g>
  ...
  <a target="_blank" href="https://zenuml.atlassian.net/servicedesk">Get support</a>
</div>
</template>
