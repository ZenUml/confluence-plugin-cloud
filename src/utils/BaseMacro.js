...
class BaseMacro {
  ...
  constructor(ap, macroIdentifier, customContentType) {
    this._confluenceWrapper = new ConfluenceWrapper(ap);
    this._macroIdentifier = macroIdentifier;
    this._customContentType = customContentType;
  }
  ...
  getCustomContentType() {
    return `ac:${this._confluenceWrapper.getMacroKey()}:${this._customContentType}`;
  }
